...
class Test_FetchTrends:
    ...
    def __init__(self):
        trend_url="https://api.twitter.com/1.1/trends/place.json?id="
        headers={"Authorization": "Bearer {}".format(twitter_token)}
        params = {
            'id': ['2490383','4118', '1105779', '44418', '2295019'],
            'names': ['seattle','toronto', 'sydney','london','newdelhi']
            }
